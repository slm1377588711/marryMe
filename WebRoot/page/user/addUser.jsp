...
<html>
	...
	<section>
	<form class="form" onsubmit="return check()" method="post" action="${pageContext.request.contextPath}/user/UserServlet?method=adduser" name = "myform">	
		<p>
			<label for="user_name">昵称</label>
			<input type="text" onchange="checkUsername()" id="user_name" onfocus="checkUserNname()" autofocus name="user_name" required = "required"/>
...
<script type="text/javascript">
	...
	function checkUserNname(){
		...
		userNameInfoObj.style.color="#ccc";
	...
	function checkUserPassword(){
		...
		userpasswordInfoObj.style.color="#ccc";
	...
	function checkUserEmailInfo(){
		...
		userEmailInfoObj.style.color="#ccc";
	...
	function checkUserPhoneInfo(){
		...
		userPhoneInfoObj.style.color="#ccc";
	...
	function check(){
		...
		if(useremailval==" "){
			...
			useremailInfo.style.color="#f66";
			useremailInfo.style['font-size']="15px";
			useremailInfo.innerHTML="<i class='fa fa-close'></i>请输入正确的邮箱格式";
			return false;
		}else{
		...
		if(userphoneval==" "){
			...
			userphoneInfo.style.color="#f30";
			userphoneInfo.style['font-size']="15px";
			userphoneInfo.innerHTML="<i class='fa fa-close'></i>请输入正确的手机号码";
			return false;
		}else{
